...
public class FeedbackApi extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) 
		...
		String result = feedbackObj.insertFeedback(request.getParameter("CustomerName"),
				request.getParameter("CustomerEmail"), request.getParameter("Rate"),
				request.getParameter("FeedbackNotes"));
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) 
		...
		String result = feedbackObj.updateFeedback(param.get("hidFeedbackIDSave").toString(),
				...
				param.get("Rate").toString().toString().replace("+", " "),
				param.get("FeedbackNotes").toString());
